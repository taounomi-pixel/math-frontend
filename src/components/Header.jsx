                      ...
                      >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          {hasAnyBinding ? (
                            ...
                            <span style={{ fontSize: '10px', color: '#f59e0b', background: '#fffbeb', padding: '2px 6px', borderRadius: '10px', fontWeight: 600 }}>未锁定</span>
          ...
          <div className="container mobile-nav-inner">
            ...
            <div className="mobile-actions">
              ...
              <button className="btn-outline mobile-nav-btn" onClick={() => setLang(lang === 'zh' ? 'en' : 'zh')}>
                ...
                <Globe size={16} /> {t('language')}: {lang === 'zh' ? '中文' : 'English'}
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  {mfaStep === 'select' ? (
                    ...
                    <>
                      ...
                      <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-secondary)', marginBottom: '16px', letterSpacing: '0.02em', textTransform: 'uppercase' }}>{lang === 'zh' ? '已支持的第三方账号' : 'Supported Providers'}</h4>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 130px', gap: '10px', width: '100%' }}>
                      ...
                      >
                        ...
                        {registerOtpCooldown > 0 ? `重发 (${registerOtpCooldown}s)` : (lang === 'zh' ? '获取验证码' : 'Send Code')}
            ...
            <div className={isBindModalClosing ? "ios-modal-closing" : "ios-modal-anim"} style={{
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ fontSize: '13.5px', color: 'var(--text-tertiary)', fontWeight: 500 }}>管理您的第三方登录绑定</p>
                            ...
                            <div>
                              ...
                              {isBound ? (
                                ...
                                <span style={{ fontSize: '11px', color: '#16a34a', fontWeight: 500 }}>
                                  ...
                                  {key === 'email' ? currentUser.email : <span>已绑定</span>}
