...
const translations = {
  en: {
    ...
    manageBindings: "Manage your third-party login bindings",
    supportedAccounts: "Supported third-party accounts",
    bindingTip: "After binding a third-party account, you can quickly sign in and enjoy two-factor authentication protection.",
    linked: "Linked",
    unlinked: "Unlinked",
    change: "Change",
    unbind: "Unbind",
    ...
    selectVerifyMethod: "Select Verification Method",
    verifyVia: "Verify via {method}",
    noVerifyProvider: "No verification provider found, please contact admin.",
    ...
    setUsernamePlaceholder: "Set your username",
  ...
  zh: {
    ...
    manageBindings: "管理您的第三方登录绑定",
    supportedAccounts: "已支持的第三方账号",
    bindingTip: "绑定第三方账号后，您可以使用该账号快捷登录，并享受双重身份验证保护。",
    linked: "已绑定",
    unlinked: "未绑定",
    change: "更换",
    unbind: "解绑",
    bindNewEmail: "绑定新邮箱",
    confirmChange: "确认更换",
    selectVerifyMethod: "请选择验证方式",
    verifyVia: "通过 {method} 验证",
    noVerifyProvider: "无法识别验证渠道，请联系管理员",
    enterCode: "输入验证码",
    codeSentTo: "验证码已发送至 {email}",
    resend: "重新获取",
    verifying: "验证中...",
    completeLogin: "完成登录",
    backToOptions: "← 返回选择其他方式",
    loginWithOther: "使用其他账号登录",
    passwordLogin: "密码登录",
    otpLogin: "验证码登录",
    emailAddress: "邮箱地址",
    enterEmailPlaceholder: "请输入邮箱",
    enterCodePlaceholder: "请输入验证码",
    setUsernamePlaceholder: "设置登录用户名",
    setPasswordPlaceholder: "设置登录密码",
