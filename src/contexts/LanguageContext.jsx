...
const translations = {
  en: {
    ...
    descTopology: "Properties that are preserved through deformations, twistings, and stretchings... 拓扑结构可视化。",
